#ifndef INITIAL_POSE_FACTOR_H
#define INITIAL_POSE_FACTOR_H
    ...
    if (jacobians) {
      if (jacobians[0]) {
        ...
        jacobian_pose.block<3, 3>(3, 3) =
            Common::Qleft(init_Q.inverse() * Q).bottomRightCorner<3, 3>();
