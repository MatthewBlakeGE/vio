  ...
  if (jacobians) {
    ...
    if (jacobians[0]) {
      ...
      jaco_i.rightCols<3>() = ric2.transpose() * Rj.transpose() * Ri *
                              -Common::skewSymmetric(pts_imu_i);
    ...
    if (jacobians[1]) {
      ...
      jaco_j.rightCols<3>() =
          ric2.transpose() * Common::skewSymmetric(pts_imu_j);
    ...
    if (jacobians[2]) {
      ...
      jaco_ex.rightCols<3>() = ric2.transpose() * Rj.transpose() * Ri * ric *
                               -Common::skewSymmetric(pts_camera_i);
    ...
    if (jacobians[3]) {
      ...
      jaco_ex.rightCols<3>() = Common::skewSymmetric(pts_camera_j);
...
void ProjectionTwoFrameTwoCamFactor::check(double** parameters) {
  ...
  for (int k = 0; k < 26; k++) {
    ...
    if (a == 0)
      ...
      Qi = Qi * Common::deltaQ(delta);
    else if (a == 2)
      Pj += delta;
    else if (a == 3)
      Qj = Qj * Common::deltaQ(delta);
    else if (a == 4)
      tic += delta;
    else if (a == 5)
      qic = qic * Common::deltaQ(delta);
    else if (a == 6)
      tic2 += delta;
    else if (a == 7)
      qic2 = qic2 * Common::deltaQ(delta);
    else if (a == 8) {
      if (b == 0)
        inv_dep_i += delta.x();
      else
