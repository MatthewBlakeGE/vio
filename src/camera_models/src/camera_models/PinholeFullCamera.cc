...
double& PinholeFullCamera::Parameters::k1(void) {
  return m_k1;
}

double& PinholeFullCamera::Parameters::k2(void) {
  return m_k2;
}

double& PinholeFullCamera::Parameters::k3() {
  return m_k3;
}

double& PinholeFullCamera::Parameters::k4() {
  return m_k4;
}

double& PinholeFullCamera::Parameters::k5() {
  return m_k5;
}

double& PinholeFullCamera::Parameters::k6() {
  return m_k6;
}

double& PinholeFullCamera::Parameters::p1(void) {
  return m_p1;
}

double& PinholeFullCamera::Parameters::p2(void) {
  return m_p2;
}

double& PinholeFullCamera::Parameters::fx(void) {
  return m_fx;
}

double& PinholeFullCamera::Parameters::fy(void) {
  return m_fy;
}

double& PinholeFullCamera::Parameters::cx(void) {
  return m_cx;
}

double& PinholeFullCamera::Parameters::cy(void) {
  return m_cy;
}

double PinholeFullCamera::Parameters::k1(void) const {
  return m_k1;
}

double PinholeFullCamera::Parameters::k2(void) const {
  return m_k2;
}

double PinholeFullCamera::Parameters::p1(void) const {
  return m_p1;
}

double PinholeFullCamera::Parameters::p2(void) const {
  return m_p2;
}

double PinholeFullCamera::Parameters::fx(void) const {
  return m_fx;
}

double PinholeFullCamera::Parameters::fy(void) const {
  return m_fy;
}

double PinholeFullCamera::Parameters::cx(void) const {
  return m_cx;
}

double PinholeFullCamera::Parameters::cy(void) const {
  return m_cy;
}

double PinholeFullCamera::Parameters::k3() const {
  return m_k3;
}

double PinholeFullCamera::Parameters::k4() const {
  return m_k4;
}

double PinholeFullCamera::Parameters::k5() const {
  return m_k5;
}

double PinholeFullCamera::Parameters::k6() const {
  return m_k6;
}
...
int PinholeFullCamera::parameterCount(void) const {
  return 12;
}
